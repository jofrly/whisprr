...
1. Create a [Gemini API-Key](https://aistudio.google.com/api-keys) & copy it
2. [Download](https://github.com/jofrly/whisprr/releases)
3. Install the app & start it
4. Click on the "Microphone" icon in the status bar and set the API-Key (Right click + Paste)
